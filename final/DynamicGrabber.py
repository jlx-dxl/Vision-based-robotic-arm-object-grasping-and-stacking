...
class DynamicGrabber():
    def __init__(self, detector, arm, team, ik, fk):
        ...
        # 4 6, plus is look up, minus is look down
            ...
            self.pre_pose = np.array([ 0.7945-0.3, -1.6317, -1.6219, -0.8847, -0.2694,  1.6976, -0.8327] )
            self.wait_pose = np.array([ 0.7945, -1.6317, -1.6219, -0.8847, -0.2694,  1.6976, -0.8327] )
            ...
            self.pre_pose = np.array([ 0.9728-0.3,  1.2579,  0.75  , -0.8674,  0.5607,  1.6436, -1.1162] )
            self.wait_pose = np.array([ 0.9728,  1.2579,  0.75  , -0.8674,  0.5607,  1.6436, -1.1162] )
            self.setpoint = np.array([
